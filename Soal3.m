...
% Last Modified by GUIDE v2.5 21-Sep-2022 00:18:30
...
% --- Executes on button press in soal3__histogramEqualizationBtn.
function soal3__histogramEqualizationBtn_Callback(hObject, eventdata, handles)
set(handles.soal3__histogramEqualizationBtn,'Enable','off');
set(handles.soal3__histogramEqualizationBtn,'String','0%');
fullname = get(handles.soal3__directory, 'String');

img = imread(fullname);
grayscaleImg = im2gray(img);
set(handles.soal3__histogramEqualizationBtn,'String','10%');
...
imshow(outputImage, []);
set(handles.soal3__histogramEqualizationBtn,'String','60%');

axes(handles.soal3__inputHist);
grayscaleHistogram(grayscaleImg);
set(handles.soal3__histogramEqualizationBtn,'String','80%');
title('Histogram');

axes(handles.soal3__outputHistR);
grayscaleHistogram(outputImage);
title('Output Histogram');
set(handles.soal3__histogramEqualizationBtn,'String','100%');
set(handles.soal3__histogramEqualizationBtn,'String','Equalize');
set(handles.soal3__histogramEqualizationBtn,'Enable','on');
