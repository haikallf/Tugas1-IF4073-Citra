...
% Last Modified by GUIDE v2.5 20-Sep-2022 01:44:52
...
% --- Executes on button press in navitem__soal1.
function navitem__soal1_Callback(hObject, eventdata, handles)
close(Home);
Soal1;


% --- Executes on button press in navitem__soal2.
function navitem__soal2_Callback(hObject, eventdata, handles)
close(Home);
Soal2;


% --- Executes on button press in navitem__soal3.
function navitem__soal3_Callback(hObject, eventdata, handles)
close(Home);
Soal3;


% --- Executes on button press in navitem__soal4.
function navitem__soal4_Callback(hObject, eventdata, handles)
close(Home);
Soal4;
